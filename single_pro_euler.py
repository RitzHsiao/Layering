...
def euler(protruison_no, revise_dis):
    ...
    for file0_no in range(0, len(f0)):
        ...
        # 共用一邊-------------------------------------------
        # 24/12/12
        A = [4.25249e+02, 1.321365e+03, -1.84589e+02]
        B = [4.81069e+02, 1.492140e+03, -1.82340e+02]
        C = [3.99130e+02, 1.492140e+03, -1.2046e+01]
        D = [4.00499e+02, 1.321368e+03, -1.84589e+02]
        # # 24/12/10
        # A = [4.25170e+02, 1.321547e+03, -1.85179e+02]
        # B = [4.81695e+02, 1.492192e+03, -1.81953e+02]
        # C = [4.02317e+02, 1.492192e+03, -1.2279e+01]
        # D = [4.02559e+02, 1.321232e+03, -1.85179e+02]
        # # 06/27
    ...
    SaveFile('C:\\Users\\User\\Desktop\\hiwin_control_example - 複製\\xyzRxyz\\NEWxyzRxyz{}.xyz'.format(protruison_no), AllxyzRxyz0)
    SaveFile('C:\\Users\\User\\Desktop\\ritz_hiwin_control\\xyzRxyz\\NEWxyzRxyz{}.xyz'.format(protruison_no), AllxyzRxyz0)
    return gdt, Ngdt

def inc_euler(protruison_no, revise_dis):
    # wheel_error = float(input('砂輪消耗深度wheel_error = '))   # 單位mm
    robot_error = float(revise_dis)  # 單位mm  1.1
    print("robot error = ", robot_error)
    # lastlayer_adddepth = float(input('細磨深度lastlayer_adddepth = '))
    ...
    f0 = sorted(glob.glob(os.path.join("grindcinc{}/".format(protruison_no), "*.xyz")), key=lambda x: (
        int(re.split('eTt{}_|_|.xyz'.format(protruison_no), x)[1]),
        int(re.split('eTt{}_|_|.xyz'.format(protruison_no), x)[2])))
    ...
    for file0_no in range(0, len(f0)):
        ...
        # 24/12/12
        A = [4.25240e+02, 1.321365e+03, -1.84589e+02]
        B = [4.81069e+02, 1.492140e+03, -1.82340e+02]
        C = [3.99130e+02, 1.492140e+03, -1.2046e+01]
        D = [4.00499e+02, 1.321368e+03, -1.84589e+02]
        # # 24/12/10
    ...
    SaveFile('C:\\Users\\User\\Desktop\\hiwin_control_example\\xyzRxyz\\INCxyzRxyz{}.xyz'.format(protruison_no), AllxyzRxyz0)
    #SaveFile('C:\\Users\\User\\Desktop\\hiwin_control_example - 複製\\xyzRxyz\\INCxyzRxyz{}.xyz'.format(protruison_no), AllxyzRxyz0)
    SaveFile('D:\\euler\\euler_angle\\xyzRxyz\\INCxyzRxyz{}.xyz'.format(protruison_no), AllxyzRxyz0)
    #SaveFile('C:\\Users\\User\\Desktop\\ritz_hiwin_control\\xyzRxyz\\{}.xyz'.format(protruison_no), AllxyzRxyz0)
    return gdt, Ngdt
